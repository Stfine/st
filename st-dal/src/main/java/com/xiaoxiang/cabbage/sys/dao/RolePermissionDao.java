...
import com.xiaoxiang.cabbage.sys.mapper.RolePermissionMapper;
...
public class RolePermissionDao {
   ...
   /** generate code begin**/
	...
	public int delete( java.lang.Long roleId, java.lang.Long permissionId){
		return mapper.deleteByPrimaryKey(roleId,permissionId);
	}
	/** generate code end**/
}
